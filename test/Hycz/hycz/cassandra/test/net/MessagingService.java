...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    private final Map<TestVerb, IVerbHandler> verbHandlers_;
...
//    private final Map<StorageService.Verb, AtomicInteger> droppedMessages = new EnumMap<StorageService.Verb, AtomicInteger>(StorageService.Verb.class);
    private final Map<TestVerb, AtomicInteger> droppedMessages = new EnumMap<TestVerb, AtomicInteger>(TestVerb.class);
    private final List<ILatencySubscriber> subscribers = new ArrayList<ILatencySubscriber>();

    {
        for (TestVerb verb : TestVerb.values())
    ...
    private MessagingService()
    {
        ...
        verbHandlers_ = new EnumMap<TestVerb, IVerbHandler>(TestVerb.class);
