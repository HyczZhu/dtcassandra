...
import hycz.cassandra.testBase.SimpleController;

public abstract class TestBaseWithoutWhirr{
    private static final Logger logger = LoggerFactory.getLogger(TestBase.class);
    
    protected static SimpleController controller =
    	SimpleController.getInstance();
    
    public TestBaseWithoutWhirr(){
...
//    }
        ...
        throws IOException
    {
        ...
        {
        	//TODO realize getPublicHost method. For now always return null.
